 ...
 */
bool mitsubishi_heavy_ir_encode_state(const MitsubishiHeavyRequest* req, uint32_t* timings, size_t* timings_count);
...
void mitsubishi_heavy_ir_format_toggle(const MitsubishiHeavyRequest* req, MitsubishiHeavyToggle toggle, char* out, size_t len);

/** Same, for an Extra-screen entry. */
void mitsubishi_heavy_ir_format_extra(const MitsubishiHeavyRequest* req, MitsubishiHeavyExtra extra, char* out, size_t len);
