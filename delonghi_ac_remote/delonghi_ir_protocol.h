...
void delonghi_ir_format_toggle(const DelonghiRequest* req, DelonghiToggle toggle, char* out, size_t len);

/** Same, for an Extra-screen entry. */
void delonghi_ir_format_extra(const DelonghiRequest* req, DelonghiExtra extra, char* out, size_t len);
