 ...
 */
bool mitsubishi_ir_encode_state(const MitsubishiRequest* req, uint32_t* timings, size_t* timings_count);
...
void mitsubishi_ir_format_toggle(const MitsubishiRequest* req, MitsubishiToggle toggle, char* out, size_t len);

/** Same, for an Extra-screen entry. */
void mitsubishi_ir_format_extra(const MitsubishiRequest* req, MitsubishiExtra extra, char* out, size_t len);
