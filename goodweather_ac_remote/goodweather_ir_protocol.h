 ...
 */
bool goodweather_ir_encode_state(const GoodweatherRequest* req, uint32_t* timings, size_t* timings_count);
...
void goodweather_ir_format_toggle(const GoodweatherRequest* req, GoodweatherToggle toggle, char* out, size_t len);

/** Same, for an Extra-screen entry. */
void goodweather_ir_format_extra(const GoodweatherRequest* req, GoodweatherExtra extra, char* out, size_t len);
