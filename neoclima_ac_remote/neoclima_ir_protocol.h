...
void neoclima_ir_format_toggle(const NeoclimaRequest* req, NeoclimaToggle toggle, char* out, size_t len);

/** Same, for an Extra-screen entry. */
void neoclima_ir_format_extra(const NeoclimaRequest* req, NeoclimaExtra extra, char* out, size_t len);
