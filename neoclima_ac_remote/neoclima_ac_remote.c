...
static NeoclimaApp* neoclima_app_alloc(void) {
    ...
    view_dispatcher_set_navigation_event_callback(app->view_dispatcher, neoclima_app_back_callback);
    ...
    app->ir_tx_stop_timer = furi_timer_alloc(neoclima_app_tx_stop_callback, FuriTimerTypeOnce, app);
    app->is_sending = false;
