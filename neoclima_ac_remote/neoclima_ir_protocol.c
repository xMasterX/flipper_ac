...
bool neoclima_ir_encode_toggle(
    ...
    uint8_t st[STATE_LEN];
    build_state(
        req, toggle != NeoclimaTogglePowerOff, TOGGLE_BUTTONS[toggle], NO_EXTRAS, st);
    return encode_state_bytes(st, timings, timings_count);
}
...
bool neoclima_ir_encode_extra(
    ...
    switch(extra) {
    case NeoclimaExtraSwingH: ef.swing_h = true; break;
    case NeoclimaExtraFresh: ef.fresh = true; break;
    case NeoclimaExtraEye: ef.eye = true; break;
    case NeoclimaExtraHold: ef.hold = true; break;
    case NeoclimaExtra8CHeat: ef.cheat = true; break;
    default: break;
    }
