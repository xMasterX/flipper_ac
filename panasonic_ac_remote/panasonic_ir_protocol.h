 ...
 */
bool panasonic_ir_encode_state(const PanasonicRequest* req, uint32_t* timings, size_t* timings_count);
...
void panasonic_ir_format_toggle(const PanasonicRequest* req, PanasonicToggle toggle, char* out, size_t len);

/** Same, for an Extra-screen entry. */
void panasonic_ir_format_extra(const PanasonicRequest* req, PanasonicExtra extra, char* out, size_t len);
