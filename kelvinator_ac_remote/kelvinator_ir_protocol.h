 ...
 */
bool kelvinator_ir_encode_state(const KelvinatorRequest* req, uint32_t* timings, size_t* timings_count);
...
void kelvinator_ir_format_toggle(const KelvinatorRequest* req, KelvinatorToggle toggle, char* out, size_t len);

/** Same, for an Extra-screen entry. */
void kelvinator_ir_format_extra(const KelvinatorRequest* req, KelvinatorExtra extra, char* out, size_t len);
